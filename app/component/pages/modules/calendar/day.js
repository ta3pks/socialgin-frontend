                        ...
                        for(let i=0; i<24; i++){
                            ...
                            yansit.push(
                                <li key={window.keyGenerator()} className="events">
                                    {(_=>{
                                        const evetList = []
                                        for(let q=0; q<that.props.events.length; q++){
                                            let thisDate = new Date(that.props.events[q].date);
                                            let nowDate =  that.props.dayDate;
                                            if(thisDate.getFullYear() == nowDate.getFullYear() && thisDate.getMonth() == nowDate.getMonth() + 1 && thisDate.getDate() == nowDate.getDate() && thisDate.getHours() == i){
                                                evetList.push(
