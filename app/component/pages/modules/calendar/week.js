                    ...
                    {(_=>{
                        ...
                        while(dayNumber < 7){
                            ...
                            for(let i=0; i<that.props.events.length; i++){
                                ...
                                let nowDate =  day
                                if(thisDate.getMonth() == nowDate.getMonth() + 1 && thisDate.getDate() == nowDate.getDate()){
                                    events.push(
                                    ...
                                    events.push(<div key={window.keyGenerator()}></div>)
                                }
                            }
                            data.push(<li key={window.keyGenerator()}>
                                {events}
                            </li>);
                            day = new Date(day.getTime() + 24 * 60 * 60 * 1000);
                            dayNumber++
