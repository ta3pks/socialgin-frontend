...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _accounts = __webpack_require__(201);
	...
	var _shareSystem = __webpack_require__(205);

	var _shareSystem2 = _interopRequireDefault(_shareSystem);
	    ...
	    _createClass(Layout, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_shareSystem2.default, null),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _routerActioNs = __webpack_require__(200);
	    ...
	    _createClass(Sidebar, [{
	        ...
	        value: function changePage(e) {
	            if (e.target.nodeName == "LI") {
	                ...
	                this.props.dispatch((0, _routerActioNs.Route)(page));
	        ...
	        value: function componentWillMount() {
	            this.props.dispatch((0, _routerActioNs.Route)(window.location.pathname));
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "div",
	                { className: this.state.toggle ? "left-menu animate" : "left-menu" },
	                _react2.default.createElement(
	                    "div",
	                    { className: "menu-toggle" },
	                    _react2.default.createElement(
	                        "div",
	                        { className: "open", onClick: function (_) {
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { className: "close", onClick: function (_) {
	                                _this2.setState({ toggle: !_this2.state.toggle });
	                            }.bind(this) },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "li",
	                            { onClick: this.changePage.bind(this), "data-page": "dashboard", className: this.props.page === "/dashboard" ? "active" : false },
	                            _react2.default.createElement(
	                                "div",
	                                { className: "menu-item" },
	                                _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "li",
	                            { className: "bottom", onClick: this.logout.bind(this) },
	                            _react2.default.createElement(
	                                "div",
	                                { className: "menu-item" },
	                                _react2.default.createElement(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _accountActions = __webpack_require__(202);
	...
	var Accounts = (_dec = (0, _reactRedux.connect)(function (store) {
	  return {
	  ...
	  _createClass(Accounts, [{
	    key: "accountSearcher",
	    value: function accountSearcher(e) {
	      this.setState({ searchAccount: e.target.value });
	    }
	  }, {
	    key: "openModal",
	    value: function openModal() {
	      this.props.dispatch((0, _modalActions.modalToggle)());
	    }
	  }, {
	    key: "selectAccount",
	    value: function selectAccount(e) {
	      ...
	      this.props.dispatch((0, _accountActions.selectAccount)(target.id));
	    }
	  }, {
	    key: "componentWillMount",
	    value: function componentWillMount() {
	      ...
	      ajax.onreadystatechange = function () {
	        ...
	        that.props.dispatch((0, _accountActions.fetchAccounts)(res.data));
	      };
	      ajax.send();
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "button",
	            { onClick: that.openModal.bind(this), className: "btn-circle" },
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement("input", { onChange: this.accountSearcher.bind(this), value: this.state.searchAccount, type: "search", className: "input-search", placeholder: "Search accounts" })
	        ),
	        _react2.default.createElement(
	          "div",
	                ...
	                if (list.hasOwnProperty(key)) {
	                  ...
	                  if (RegExp(that.state.searchAccount, 'i').test(account.fullname)) {
	                    data.push(_react2.default.createElement(
	                      "li",
	                      { "data-id": account.id, onClick: that.selectAccount.bind(that), key: account.id, className: account.type + " " + active },
	                      _react2.default.createElement("img", { src: account.picture, alt: account.fullname }),
	                      _react2.default.createElement("div", { className: "social-from" }),
	                      _react2.default.createElement(
	                        "span",
	                        null,
	                        account.fullname
...
/***/ (function(module, exports) {
	...
	function fetchAccounts(account_info) {
	    return {
	        type: "FETCH_ACCOUNT",
...
/***/ (function(module, exports) {
	...
	function modalToggle(account_info) {
	    return {
	        type: "TOGGLE"
	    };
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Modal = (_dec = (0, _reactRedux.connect)(function (store) {
	    ...
	    _createClass(Modal, [{
	            ...
	            FB.login(function (response) {
	                if (response.status == "connected") {
	                    FB.api("/me", "get", { fields: "id,name,picture,groups{id,name,picture{url}},accounts{photos{picture},name,id,access_token}" }, function (res) {
	                        ...
	                        var profile = that.state.facebook.slice();
	                        profile.push({
	                            id: res.id,
	                            fullname: res.name,
	                        ...
	                        if (res.accounts) {
	                            for (var i = 0; i < res.accounts.data.length; i++) {
	                                ...
	                                var _profile = that.state.facebook.slice();
	                                _profile.push({
	                                ...
	                                that.setState({ facebook: _profile });
	                            }
	                        }
	                        if (res.groups) {
	                            for (var i = 0; i < res.groups.data.length; i++) {
	                                ...
	                                var _profile2 = that.state.facebook.slice();
	                                _profile2.push({
	                                ...
	                                that.setState({ facebook: _profile2 });
	                            }
	                        }
	        ...
	        key: "facebookSelectAccount",
	        value: function facebookSelectAccount(e) {
	            var that = this;
	            var target = e.target;
	            if (e.target.nodeName == "LI") {
	                target = e.target;
	            ...
	            if (that.props.accounts[account.id]) {
	                that.props.dispatch((0, _accountActions.removeAccount)(id));
	                ajax.open("POST", "/api/facebook/remove_account", true);
	                ajax.onload = function () {
	                    var res = JSON.parse(ajax.response);
	                    if (res.error) {
	                        that.props.dispatch((0, _accountActions.addAccount)(account));
	                    }
	                };
	                ajax.send(JSON.stringify({
	                    id: id
	        ...
	        key: "twitterSelectAccount",
	        value: function twitterSelectAccount(e) {
	            var that = this;
	            var target = e.target;
	            if (e.target.nodeName == "LI") {
	                target = e.target;
	        ...
	        key: "linkedinSelectAccount",
	        value: function linkedinSelectAccount(e) {
	            var that = this;
	            var target = e.target;
	            if (e.target.nodeName == "LI") {
	                target = e.target;
	            ...
	            if (window.location.search) {
	                ...
	                if (data.add_account || data.add_account == "true") {
	                    ...
	                    if (data.type == "twitter") {
	                        ...
	                        that.props.dispatch((0, _modalActions.modalToggle)());
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "div",
	                { className: that.props.toggle ? "modal active" : "modal" },
	                _react2.default.createElement(
	                    "div",
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "button",
	                            { className: "modal-close-button", onClick: that.closeModal.bind(this) },
	                            "X"
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                "div",
	                                { onClick: that.chanceTab.bind(that), "data-tab": "facebook", className: that.state.tab == "facebook" ? "social-media facebook active" : "social-media facebook" },
	                            ...
	                            _react2.default.createElement(
	                                "div",
	                                { onClick: that.chanceTab.bind(that), "data-tab": "twitter", className: that.state.tab == "twitter" ? "social-media twitter active" : "social-media twitter" },
	                            ...
	                            _react2.default.createElement(
	                                "div",
	                                { onClick: that.chanceTab.bind(that), "data-tab": "linkedin", className: that.state.tab == "linkedin" ? "social-media linkedin active" : "social-media linkedin" },
	                        ...
	                        _react2.default.createElement(
	                            "div",
	                            { className: "social-media-explanation" },
	                            _react2.default.createElement(
	                                "div",
	                                { className: that.state.tab == "facebook" ? "modal-part active" : "modal-part" },
	                                _react2.default.createElement(
	                                    "strong",
	                                    null,
	                                    "Add Pages, Groups, and Profiles"
	                                ),
	                                _react2.default.createElement(
	                                    "p",
	                                    null,
	                                    "Once you connect, you will be able to add :"
	                                ),
	                                _react2.default.createElement(
	                                    "div",
	                                    { className: "options" },
	                                ...
	                                _react2.default.createElement(
	                                    "div",
	                                    { className: "social-button facebook", onClick: that.facebookLogin.bind(that) },
	                                    _react2.default.createElement(
	                                        "div",
	                                        { className: "icon" },
	                                        _react2.default.createElement("i", { className: "fa fa-facebook" })
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        this.state.facebook.map(function (account) {
	                                            ...
	                                            var className = isContain ? "active" : "";
	                                            return _react2.default.createElement(
	                                                "li",
	                                                { onClick: that.facebookSelectAccount.bind(that), className: "facebook " + className, key: account.id, "data-accesstoken": account.access_token, "data-fullname": account.fullname, "data-picture": account.picture, "data-id": account.id, "data-type": account.type },
	                                                _react2.default.createElement("img", { src: account.picture, alt: account.fullname }),
	                                                _react2.default.createElement("div", { className: "social-from" }),
	                                                _react2.default.createElement(
	                                                    "span",
	                            ...
	                            _react2.default.createElement(
	                                "div",
	                                { className: that.state.tab == "twitter" ? "modal-part active" : "modal-part" },
	                                _react2.default.createElement(
	                                    "strong",
	                                    null,
	                                    "Add Twitter Profile"
	                                ...
	                                _react2.default.createElement(
	                                    "p",
	                                    null,
	                                    "To allow Socialgin access to your Twitter account, you must first give authorization from Twitter.com"
	                                ),
	                                _react2.default.createElement("br", null),
	                                _react2.default.createElement("br", null),
	                                _react2.default.createElement(
	                                    "div",
	                                    { className: "social-button twitter", onClick: that.twitterLogin.bind(that) },
	                                    _react2.default.createElement(
	                                        "div",
	                                        { className: "icon" },
	                                        _react2.default.createElement("i", { className: "fa fa-twitter" })
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        this.state.twitter.map(function (account) {
	                                            ...
	                                            return _react2.default.createElement(
	                                                "li",
	                                                { onClick: that.twitterSelectAccount.bind(that), className: "twitter " + className, key: account.id, "data-accesstoken": account.access_token, "data-accesstokensecret": account.access_token_secret, "data-fullname": account.fullname, "data-picture": account.picture, "data-id": account.id, "data-type": account.type },
	                                                _react2.default.createElement("img", { src: account.picture, alt: account.fullname }),
	                                                _react2.default.createElement("div", { className: "social-from" }),
	                                                _react2.default.createElement(
	                                                    "span",
	                            ...
	                            _react2.default.createElement(
	                                "div",
	                                { className: that.state.tab == "linkedin" ? "modal-part active" : "modal-part" },
	                                _react2.default.createElement(
	                                    "strong",
	                                    null,
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        "div",
	                                        { className: "title", onClick: that.linkedinLogin.bind(that) },
	                                        "Login with Linkedin"
	                                    )
	                                ),
	                                _react2.default.createElement("br", null),
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        this.state.linkedin.map(function (account) {
	                                            ...
	                                            return _react2.default.createElement(
	                                                "li",
	                                                { onClick: that.linkedinSelectAccount.bind(that), className: "linkedin " + className, key: account.id, "data-accesstoken": account.access_token, "data-fullname": account.fullname, "data-picture": account.picture, "data-id": account.id, "data-type": account.type },
	                                                _react2.default.createElement("img", { src: account.picture, alt: account.fullname }),
	                                                _react2.default.createElement("div", { className: "social-from" }),
	                                                _react2.default.createElement(
	                                                    "span",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _shareActions = __webpack_require__(206);
	...
	var ShareSystem = (_dec = (0, _reactRedux.connect)(function (store) {
	    return {
	        accounts: store.Accounts.list
	    };
	}), _dec(_class = function (_React$Component) {
	    _inherits(ShareSystem, _React$Component);

	    function ShareSystem() {
	        _classCallCheck(this, ShareSystem);

	        var _this = _possibleConstructorReturn(this, (ShareSystem.__proto__ || Object.getPrototypeOf(ShareSystem)).call(this));
	        ...
	        var years = [];
	        for (var _i = now.getFullYear(); _i < now.getFullYear() + 10; _i++) {
	            years.push(_i.toString());
	        }
	        _this.state = {
	            calendar: false,
	            link: false,
	    ...
	    _createClass(ShareSystem, [{
	        ...
	        key: "minuteHandler",
	        value: function minuteHandler(e) {
	            this.setState({
	            ...
	            that.setState({ images: [] }, function () {
	                for (var i = 0; i < files.length; i++) {
	                    ...
	                    reader.onload = function (e) {
	                        var fileList = that.state.images.slice();
	        ...
	        key: "fileOpenner",
	        value: function fileOpenner(e) {
	            var inputField = this.refs.fileField;
	            inputField.click();
	        }
	    }, {
	        key: "shareHandler",
	        value: function shareHandler(e) {
	            var that = this;
	            var button = e.target;
	            button.innerHTML = "Please wait...";
	            button.disabled = true;
	            var userFound = false;
	            for (var key in that.props.accounts) {
	                if (that.props.accounts.hasOwnProperty(key)) {
	                    if (that.props.accounts[key].selected) {
	                        if (!that.state.link && !that.state.upload) {
	                            var date = new Date(that.state.thisYear, that.state.thisMonth, that.state.thisDay, that.state.thisHour, that.state.thisMinute);
	                            (0, _shareActions.statusUpdate)(that.props.accounts[key], that.state.status, date, that.state.notification);
	                        } else if (that.state.link) {
	                            var _date = new Date(that.state.thisYear, that.state.thisMonth, that.state.thisDay, that.state.thisHour, that.state.thisMinute);
	                            (0, _shareActions.urlShare)(that.props.accounts[key], that.state.status, _date, that.state.url, that.state.notification);
	                        } else if (that.state.upload) {
	                            var _date2 = new Date(that.state.thisYear, that.state.thisMonth, that.state.thisDay, that.state.thisHour, that.state.thisMinute);
	                            (0, _shareActions.imageShare)(that.props.accounts[key], that.state.status, _date2, that.refs.fileField.files[0], that.state.notification);
	                        }
	                        userFound = true;
	                    }
	                }
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "div",
	                            { className: "card-body" },
	                            _react2.default.createElement("textarea", { onChange: that.updateStatus.bind(that), value: that.props.status, rows: "5", className: "textarea", placeholder: "What is in your mind ?" })
	                        ),
	                        _react2.default.createElement(
	                            "div",
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    "button",
	                                    { onClick: that.openCallendar.bind(that), className: that.state.calendar ? "share-variant active" : "share-variant" },
	                                    _react2.default.createElement("i", { className: "fa fa-calendar" })
	                                ),
	                                _react2.default.createElement(
	                                    "button",
	                                    { onClick: that.openLink.bind(that), className: that.state.link ? "share-variant active" : "share-variant" },
	                                    _react2.default.createElement("i", { className: "fa fa-link" })
	                                ),
	                                _react2.default.createElement(
	                                    "button",
	                                    { onClick: that.openUpload.bind(that), className: that.state.upload ? "share-variant active" : "share-variant" },
	                                    _react2.default.createElement("i", { className: "fa fa-picture-o" })
	                                ),
	                                _react2.default.createElement(
	                                    "button",
	                                    { onClick: function (_) {
	                                            that.setState({ notification: !that.state.notification }, function (_) {
	                                                localStorage.setItem("notification", that.state.notification);
	                                            });
	                                        }.bind(that), className: that.state.notification ? "share-variant active" : "share-variant" },
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    "button",
	                                    { onClick: that.shareHandler.bind(that), type: "submit", className: "share-button" },
	                                    "Update"
	                                )
	                            )
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                "div",
	                                { className: that.state.calendar ? "calendar active" : "calendar" },
	                                _react2.default.createElement(
	                                    "div",
	                                    { className: "date" },
	                                    _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        "select",
	                                        { onChange: that.dayHandler.bind(that), value: that.state.thisDay },
	                                        that.state.days.map(function (day) {
	                                            return _react2.default.createElement(
	                                                "option",
	                                                { key: day, value: day },
	                                                day
	                                    ...
	                                    _react2.default.createElement(
	                                        "select",
	                                        { onChange: that.monthHandler.bind(that), value: that.state.thisMonth },
	                                        _react2.default.createElement(
	                                            "option",
	                                            { value: "1" },
	                                            "Janaury"
	                                    ...
	                                    _react2.default.createElement(
	                                        "select",
	                                        { onChange: that.yearHandler.bind(that), value: that.state.thisYear },
	                                        that.state.years.map(function (year) {
	                                            return _react2.default.createElement(
	                                                "option",
	                                                { key: year, value: year },
	                                                year
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        "select",
	                                        { onChange: that.hourHandler.bind(that), value: that.state.thisHour },
	                                        _react2.default.createElement(
	                                            "option",
	                                            { value: "0" },
	                                            "00"
	                                    ...
	                                    _react2.default.createElement(
	                                        "select",
	                                        { onChange: that.minuteHandler.bind(that), value: that.state.thisMinute },
	                                        _react2.default.createElement(
	                                            "option",
	                                            { value: "00" },
	                                            "00"
	                            ...
	                            _react2.default.createElement(
	                                "div",
	                                { className: that.state.link ? "share_uri active" : "share_uri" },
	                                _react2.default.createElement("input", { onChange: that.urlHandler.bind(that), value: that.state.url, type: "text", placeholder: "Please enter your url." }),
	                                _react2.default.createElement(
	                                    "div",
	                                    { className: that.state.urlMeta ? "url_info active" : "url_info" },
	                                    _react2.default.createElement(
	                                        "div",
	                                        { className: "image-area" },
	                                        _react2.default.createElement(
	                                            "a",
	                                            { href: that.state.urlMeta.url },
	                                            _react2.default.createElement("img", { src: that.state.urlMeta.picture })
	                                        )
	                                    ),
	                                    _react2.default.createElement(
	                                        "div",
	                                        ...
	                                        _react2.default.createElement(
	                                            "h1",
	                                            null,
	                                            that.state.urlMeta.title
	                                        ),
	                                        _react2.default.createElement(
	                                            "span",
	                                            null,
	                                            that.state.urlMeta.description
	                                        ),
	                                        _react2.default.createElement(
	                                            "a",
	                                            { href: that.state.urlMeta.url },
	                                            that.state.urlMeta.site
	                                        )
	                                    )
	                                )
	                            ),
	                            _react2.default.createElement(
	                                "div",
	                                { onClick: that.fileOpenner.bind(that), className: that.state.upload ? "upload_image active" : "upload_image" },
	                                _react2.default.createElement("input", { onChange: that.fileAdder.bind(that), className: "files-input", ref: "fileField", type: "file", accept: ".jpg,.jpeg,.png" }),
	                                _react2.default.createElement(
	                                    "div",
	                                    { className: "image-area" },
	                                    this.state.images.map(function (data, key) {
	                                        return _react2.default.createElement("img", { key: key, src: data });
	                                    })
	                                )
	                            )
	                        )
...
/***/ (function(module, exports) {
	...
	exports.urlShare = urlShare;
	exports.imageShare = imageShare;
	function statusUpdate(user, message, date, notification) {
	...
	function urlShare(user, message, date, link, notification) {
	...
	function imageShare(user, message, date, image, notification) {
	    if (!user || !date || !image) return swal("Error !", "Please add a photo.", "error");
	    upload(image, function (result) {
	        var ajax = new XMLHttpRequest();
	        ajax.open("POST", "/api/social-media-share", true);
	        var notifications = notification;
	        ajax.onreadystatechange = function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var middleware = (0, _redux.applyMiddleware)(error);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _accounts = __webpack_require__(209);
	        ...
	        case "FETCH_ACCOUNT":
	            {
	                ...
	                state = _extends({}, state, { list: data });
	                break;
	            }
	        case "SELECT_ACCOUNT":
	            {
	                ...
	                state = _extends({}, state, { list: accounts });
	                break;
	            }
	        case "ADD_ACCOUNT":
	            {
...
/***/ (function(module, exports) {
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        case "ROUTE":
	            {
	                state = _extends({}, state, { page: action.payload });
	                break;
	            }
	    }
	    return state;
...
/***/ (function(module, exports) {
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        case "TOGGLE":
	            {
	                state = _extends({}, state, { modal: !state.modal });
	                break;
	            }
	    }
	    return state;
